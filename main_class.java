...
public class main_class  extends JFrame implements ActionListener {
    ...
    main_class(String acctype, String meter_pass)
    {
        ...
        menu.setFont(new Font("Open Sans",Font.BOLD,22));


        JMenuItem newcustomer = new JMenuItem("New Customer");
        newcustomer.setFont(new Font("Open Sans",Font.PLAIN,16));
        ...
        customerdetails.setFont(new Font("Open Sans",Font.PLAIN,16));
        ...
        depositdetails.setFont(new Font("Open Sans",Font.PLAIN,16));
        ...
        calculatebill.setFont(new Font("Open Sans",Font.PLAIN,16));
        ...
        info.setFont(new Font("Open Sans",Font.BOLD,22));


        JMenuItem upinfo =new JMenuItem("Update Information");
        upinfo.setFont(new Font("Open Sans",Font.PLAIN,16));
        ...
        viewInfo.setFont(new Font("Open Sans",Font.PLAIN,16));
       ...
       viewInfo.addActionListener(this);
        ...
        user.setFont(new Font("Open Sans",Font.BOLD,22));


        JMenuItem paybill =new JMenuItem("Pay Bill");
        paybill.setFont(new Font("Open Sans",Font.PLAIN,16));
        ...
        billdetails.setFont(new Font("Open Sans",Font.PLAIN,16));
        ...
        bill.setFont(new Font("Open Sans",Font.BOLD,22));


        JMenuItem genBill =new JMenuItem("Generate Bill");
        genBill.setFont(new Font("Open Sans",Font.PLAIN,16));
       ...
       genBill.addActionListener(this);
        ...
        utility.setFont(new Font("Open Sans",Font.BOLD,22));



        JMenuItem notepad =new JMenuItem("Notepad");
        notepad.setFont(new Font("Open Sans",Font.PLAIN,16));
        ...
        calculator.setFont(new Font("Open Sans",Font.PLAIN,16));
        ...
        exit.setFont(new Font("Open Sans",Font.BOLD,22));



        JMenuItem eexit =new JMenuItem("Exit");
        eexit.setFont(new Font("Open Sans",Font.PLAIN,16));
