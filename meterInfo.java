...
public class meterInfo extends JFrame implements ActionListener
{
    ...
    meterInfo(String meternumber)
    {
        ...
        meterNumber.setForeground(new Color(255, 255, 255));
        panel.add(meterNumber);

        JLabel meterNumberText = new JLabel(meternumber);
        meterNumberText.setBounds(180,80,150,20);
        meterNumberText.setForeground(new Color(255, 255, 255));
        panel.add(meterNumberText);

        JLabel meterLoc = new JLabel("Meter Position");
        meterLoc.setBounds(50,120,100,20);
        meterLoc.setForeground(new Color(255, 255, 255));
        panel.add(meterLoc);
        ...
        meterTyp.setForeground(new Color(255, 255, 255));
        panel.add(meterTyp);
        ...
        phaseCode.setForeground(new Color(255, 255, 255));
        panel.add(phaseCode);
        ...
        billtyp.setForeground(new Color(255, 255, 255));
        panel.add(billtyp);
        ...
        note1.setForeground(new Color(255, 255, 255));
        panel.add(note1);
